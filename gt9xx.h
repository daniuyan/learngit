...
#define GTP_I2C_NAME                "Goodix-TS-gt928"
#define GOODIX_TS_NAME 		    "goodix-ts"
...
// Log define
#define GTP_INFO(fmt,arg...)           printk("<<-GTP-928-INFO->> "fmt"\n",##arg)
#define GTP_ERROR(fmt,arg...)          printk("<<-GTP-928-ERROR->> "fmt"\n",##arg)
